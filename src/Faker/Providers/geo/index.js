/**
 * Geographic mapping data for consistent identity generation
 * Maps regions → languages, states, and state → LGAs
 */
...
const regionMap = {
  west: {
    language: "yoruba",
    states: [
      "Lagos", "Oyo", "Osun", "Ogun", "Ondo", "Ekiti", "Kwara",
    ],
  },
  east: {
    language: "igbo",
  ...
  north: {
    language: "hausa",
    states: [
      "Kano", "Kaduna", "Katsina", "Sokoto", "Bauchi", "Borno",
      "Jigawa", "Kebbi", "Zamfara", "Yobe", "Gombe", "Adamawa",
      "Niger", "Nasarawa", "Federal Capital Territory",
    ],
  },
  south: {
    language: "igbo",
    states: [
      "Rivers", "Delta", "Bayelsa", "Cross River", "Akwa Ibom",
      "Edo", "Plateau", "Benue", "Kogi", "Taraba",
    ],
  },
}
...
const stateLgas = {
  ...
  "Osun": [
    ...
    "Egbedore", "Ejigbo", "Ifedayo", "Ifelodun", "Ila",
  ...
  "Kano": [
    ...
    "Rogo", "Shanono", "Sumaila", "Takai", "Tarauni", "Tofa",
  ...
  "Adamawa": [
    ...
    "Jada", "Larmurde", "Madagali", "Maiha", "Mayo Belwa",
  ...
  "Delta": [
    ...
    "Sapele, Delta", "Udu", "Ughelli North", "Ughelli South",
  ...
  "Plateau": [
    ...
    "Jos South", "Kanam", "Kanke", "Langtang South",
    "Langtang North", "Mangu", "Mikang", "Pankshin",
    "Qua'an Pan", "Riyom", "Shendam", "Wase",
  ],
  "Benue": [
    "Agatu", "Apa", "Ado", "Buruku", "Gboko", "Guma",
    "Gwer East", "Gwer West", "Katsina-Ala", "Konshisha",
    "Kwande", "Logo", "Makurdi", "Obi", "Ogbadibo", "Ohimini",
...
/**
 * Language-to-region lookup (reverse mapping)
 */
...
module.exports = { regionMap, stateLgas, languageToRegions }
